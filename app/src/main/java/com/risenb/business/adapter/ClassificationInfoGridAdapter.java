...
public class ClassificationInfoGridAdapter<T extends Object> extends BaseGridAdapter<T>
{
    public ClassificationInfoGridAdapter(int numColumns)
    {
        super(numColumns);
    }
    ...
    {
        return new ViewHolder(context, R.layout.home_gv_item);
    }
