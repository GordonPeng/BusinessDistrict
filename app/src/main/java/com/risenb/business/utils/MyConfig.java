...
public class MyConfig
{
    ...
    public static DisplayImageOptions optionsRound = new DisplayImageOptions.Builder()//
            .showStubImage(R.drawable.default_user) // 设置图片下载期间显示的图片
            .showImageForEmptyUri(R.drawable.default_user) // 设置图片Uri为空或是错误的时候显示的图片
            .showImageOnFail(R.drawable.default_user) // 设置图片加载或解码过程中发生错误显示的图片
            .cacheInMemory(true)//
            .cacheOnDisk(true)//
    ...
    public static DisplayImageOptions options = new DisplayImageOptions.Builder()//
            ...
            .displayer(new RoundedBitmapDisplayer(Utils.getUtils().getDimen(R.dimen.dm040))) // 设置成圆角图片
